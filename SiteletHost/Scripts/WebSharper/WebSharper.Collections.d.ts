    ...
    module Collections {
        module HashSet {
            interface HashSet<_T1> {
                ...
                arrContains(item: _T1, arr: __ABBREV.__JavaScript.Array1<_T1>): boolean;
                arrRemove(item: _T1, arr: __ABBREV.__JavaScript.Array1<_T1>): boolean;
                add(item: _T1): boolean;
                get_Count(): number;
            }
        }
        ...
        module ResizeArray {
            interface ResizeArrayProxy<_T1> {
                GetEnumerator(): __ABBREV.__WebSharper.IEnumeratorProxy1<__ABBREV.__WebSharper.ObjectProxy>;
                Add(x: _T1): void;
        ...
        interface FSharpMap<_T1, _T2> {
            ...
            GetEnumerator(): __ABBREV.__WebSharper.IEnumeratorProxy1<__ABBREV.__WebSharper.KeyValuePairProxy<_T1, _T2>>;
            GetHashCode(): number;
...
declare module __ABBREV {
    ...
    export import __LinkedList = WebSharper.Collections.LinkedList;
    export import __ResizeArray = WebSharper.Collections.ResizeArray;
    export import __Collections = WebSharper.Collections;
}
