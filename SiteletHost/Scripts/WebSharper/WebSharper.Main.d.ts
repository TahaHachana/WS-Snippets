declare module WebSharper {
    ...
    module List {
        ...
        interface T<_T1> {
            GetEnumerator(): __ABBREV.__WebSharper.IEnumeratorProxy1<_T1>;
            get_Length(): number;
    ...
    module InteropProxy {
        ...
        interface FuncWithRestProxy11<_T1, _T2> {
        }
        interface FuncWithRestProxy21<_T1, _T2, _T3> {
        }
        interface FuncWithRestProxy12<_T1, _T2, _T3, _T4> {
        }
        interface FuncWithRestProxy3<_T1, _T2, _T3, _T4, _T5> {
        }
        interface FuncWithRestProxy1<_T1, _T2, _T3, _T4, _T5, _T6> {
        }
        interface FuncWithRestProxy2<_T1, _T2, _T3, _T4, _T5, _T6, _T7> {
        }
        interface FuncWithRestProxy<_T1, _T2, _T3, _T4, _T5, _T6, _T7, _T8> {
        }
    ...
    interface ChoiceProxy11<_T1, _T2, _T3, _T4, _T5, _T6> {
    }
    interface ChoiceProxy3<_T1, _T2, _T3, _T4, _T5, _T6, _T7> {
    }
    ...
    interface IEnumeratorProxy1<_T1> {
        get_Current(): _T1;
    }
...
declare module __ABBREV {
    ...
    export import __Remoting = WebSharper.Remoting;
}
